...
legend.gradient2 = function(pnts,cols=tim.colors(64),limits=c(0,1), title='Legend', ...){
  ...
  text(max(pnts[,1]),locationn[1],labels=round(limits[1],2),pos=4, cex = 1)
  text(max(pnts[,1]),locationn[2],labels=round(limits[2],2),pos=4, cex = 1)
  text(max(pnts[,1]),locationn[3],labels=round(limits[3],2),pos=4, cex = 1)
  text(max(pnts[,1]),locationn[4],labels=round(limits[4],2),pos=4, cex = 1)
  text(max(pnts[,1]),locationn[5],labels=round(limits[5],2),pos=4, cex = 1)
}
